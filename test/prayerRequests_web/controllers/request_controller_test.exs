defmodule PrayerRequestsWeb.RequestControllerTest do
  use PrayerRequestsWeb.ConnCase

  alias PrayerRequests.Requests

  @create_attrs %{name: "some name", original_request: "some original_request", place: "some place", sanitized_request: "some sanitized_request"}
